...
export default async function AccountsPortalPage({ params }: { params: { token: string } }) {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
                <div className="bg-white p-8 rounded-3xl shadow-xl max-w-md text-center">
                    ...
                    <p className="text-slate-500 mb-6">This accounts portal access link is not valid or has been revoked.</p>
                </div>
            </div>
        );
    }
    ...
    return <AccountsPortalClient receipts={receipts} startDate={startDate} endDate={endDate} hotelName={settings?.hotel_name} />;
}
