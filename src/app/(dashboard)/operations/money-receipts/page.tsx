    ...
    if (loading) {
        return (
            <div className="space-y-8 p-4 md:p-8 max-w-[1600px] mx-auto animate-pulse">
                ...
                <div className="h-14 bg-white rounded-2xl border border-slate-100" />
                <div className="h-[500px] bg-white rounded-3xl border border-slate-100" />
            </div>
        );
    }
                                ...
                                onClick={async () => {
                                    ...
                                    try {
                                        ...
                                        if (result.success) {
                                            ...
                                            loadData(); // Manual refresh of state
                                            router.refresh();
                                        } else {
